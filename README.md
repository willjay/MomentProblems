...
Assuming [uv](https://docs.astral.sh/uv/getting-started/installation/) is installed, running `./generate_figures.sh` will generate all of the figures.
...
(a) including more data (more moments/Euclidean times) or
(b) incorporating additional mathematical hypothesis appropriate for a given
    problem (e.g., some notion of smoothness or regularity or asymptotic scaling)